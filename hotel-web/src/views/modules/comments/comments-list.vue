	...
	<div class="mod-role">
		<el-form :inline="true" :model="dataForm" @keyup.enter.native="getDataList()">
			...
			<el-form-item>
				...
				<el-button v-if="isAuth('msg:comments:delete')" type="danger" @click="deleteHandle()"
		...
		<el-table :data="dataList" border v-loading="dataListLoading" @selection-change="selectionChangeHandle"
			...
			<el-table-column fixed="right" header-align="center" align="center" width="150" label="操作">
				<template slot-scope="scope">
					<el-button type="text" size="small" v-if="isAuth('msg:comments:update')"
						@click="addOrUpdateHandle(scope.row.id)">修改</el-button>
					<el-button type="text" size="small" v-if="isAuth('msg:comments:delete')"
		...
		methods: {
			...
			deleteHandle(id) {
				...
				this.$confirm(
					...
					.then(() => {
						this.$http({
							url: this.$http.adornUrl("/yx_comments/delete"),
							method: "post",
