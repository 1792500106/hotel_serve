  ...
  <nav class="site-navbar" :class="'site-navbar--' + navbarLayoutType">
    <div class="site-navbar__header">
      <h1 class="site-navbar__brand" @click="$router.push({ name: 'home' })">
        <a class="site-navbar__brand-lg" href="javascript:;">酒店预约系统</a>
    ...
    <div class="site-navbar__body">
      ...
      <el-menu
        ...
        mode="horizontal"
      >
        <!-- <el-menu-item index="1" @click="$router.push({ name: 'login' })">
				    <template slot="title">
        ...
        <el-menu-item index="4" @click="$router.push({ name: 'personal' })">
          <template slot="title">
