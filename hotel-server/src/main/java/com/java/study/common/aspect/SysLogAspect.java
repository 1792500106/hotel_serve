package com.java.study.common.aspect;

import com.alibaba.fastjson.JSON;
import com.java.study.common.annotation.SysLog;
import com.java.study.common.utils.IPUtils;
...
import com.java.study.common.utils.HttpContextUtils;
...
public class SysLogAspect {
    ...
    @Pointcut("@annotation(com.java.study.common.annotation.SysLog)")
    ...
    private void saveSysLog(ProceedingJoinPoint joinPoint, long time) {
        ...
        sysLog.setUserId(SecurityUserIdUtils.getUserId());
        sysLog.setTime(time);
